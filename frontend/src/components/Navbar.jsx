<header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-blue-600">
  <nav className="relative max-w-5xl w-full md:flex md:items-center md:justify-between md:gap-3 mx-auto px-4 sm:px-6 lg:px-8 py-2">
    ...
    >
      <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 bg-blue-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
        <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
          <a
            className="p-2 flex items-center text-sm text-white focus:outline-hidden focus:text-white"
            href="#"
            aria-current="page"
          >
            <svg
          ...
          <a
            className="p-2 flex items-center text-sm text-white/80 hover:text-white focus:outline-hidden focus:text-white"
            href="#"
          >
            <svg
              className="shrink-0 size-4 me-3 md:me-2 block md:hidden"
